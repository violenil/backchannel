...
positive_samples = np.load("src/out2/out_pos2/data.mfcc.npy")
negative_samples = np.load("src/out2/out_neg2/data.mfcc.npy")
...
class ConvNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.fc1(x) # if x < 0 then 0 otherwise x.
